...
# Здесь пишем код
f = open('test_file/task1_data.txt', 'r', encoding='utf-8')  # Открываем файл для чтения
...
f = open('test_file/task1_answer.txt', 'w', encoding='utf-8')  # Открываем для записи файл или создаем, если такого нет
